          ...
          <div className="md:col-span-1 bg-white mr-10 shadow sm:rounded-md">
            <div className="items-center justify-center ">
              ...
              <div class="align-end m-2">
                <button className="inline-flex justify-center w-full h-fit rounded-md border border-transparent bg-green-700 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                  <span className="font-bold px-2"> + </span> Add Students
                </button>
              </div>
            </div>
